...
urlpatterns=[
    ...
    path('image/',ProfileImageView.as_view(),name='profile-image-view'),#for viewing..GET request
    path('profile/<str:filename>/',ProfileImageUploadView.as_view(),name='profile-image-upload'),#post request
