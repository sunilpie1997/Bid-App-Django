...
class AppComponent {
    constructor(router, route, authService, eventService, shareEvent, shareUser) {
        this.router = router;
        this.route = route;
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 38, vars: 6, consts: [[1, "navbar", "navbar-expand-lg", "navbar-dark", "bg-dark"], ["routerLink", "/events", 1, "navbar-brand", "mb-0", "h1", "active"], ["type", "button", "data-toggle", "collapse", "data-target", "#navbarSupportedContent", "aria-controls", "navbarSupportedContent", "aria-expanded", "false", "aria-label", "Toggle navigation", 1, "navbar-toggler"], [1, "navbar-toggler-icon"], ["id", "navbarSupportedContent", 1, "collapse", "navbar-collapse"], ["class", "navbar-nav mr-auto", 4, "ngIf"], [1, "form-inline", "my-2", "my-lg-0"], ["routerLink", "/admin"], [1, "nav-link", "navbar-brand", "mb-0", "h1", "active"], ["type", "search", "placeholder", "search to reload events", "aria-label", "Search", 1, "form-control", "mr-sm-2"], [1, "btn", "btn-secondary", "my-2", "my-sm-0", 3, "click"], ["role", "main"], [1, "album", "py-5", "bg-light"], [1, "container"], [1, "text-muted"], [1, "float-right"], ["href", "#"], ["href", "https://getbootstrap.com/"], ["href", "../getting-started/introduction/"], [1, "navbar-nav", "mr-auto"], [1, "nav-item"], ["routerLink", "/login", 1, "nav-link", "navbar-brand", "mb-0", "h1", "active"], ["routerLink", "/register", 1, "nav-link", "navbar-brand", "mb-0", "h1", "active"], [1, "nav-item", "active"], ["routerLink", "/profile", 1, "nav-link", "navbar-brand", "mb-0", "h1", "active"], [1, "nav-item", "dropdown"], ["href", "#", "id", "dropdown01", "data-toggle", "dropdown", "aria-haspopup", "true", "aria-expanded", "false", 1, "nav-link", "navbar-brand", "mb-0", "h1", "active", "dropdown-toggle"], ["aria-labelledby", "dropdown01", 1, "dropdown-menu", "bg-dark"], ["routerLink", "/events", 1, "nav-link", "navbar-brand", "mb-0", "h1", "active"], ["routerLink", "/create-event", 1, "nav-link", "navbar-brand", "mb-0", "h1", "active"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppComponent_Template_button_click_17_listener() { return ctx.refreshEvents(); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](29, "Album example is \u00A9 Bootstrap, but please download and customize it for yourself!");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
class LoginComponent {
    constructor(authService, router, route, shareUser) {
        this.authService = authService;
        this.router = router;
        this.route = route;
        this.shareUser = shareUser;
...
LoginComponent.ɵfac = function LoginComponent_Factory(t) { return new (t || LoginComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_app_services_auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_app_services_share_user_service__WEBPACK_IMPORTED_MODULE_5__["ShareUserService"])); };
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](LoginComponent, [{
    ...
    }], function () { return [{ type: _app_services_auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"] }, { type: _app_services_share_user_service__WEBPACK_IMPORTED_MODULE_5__["ShareUserService"] }]; }, null); })();
...
class RegisterComponent {
    constructor(authService, registerService, router, route) {
        this.authService = authService;
...
RegisterComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: RegisterComponent, selectors: [["app-register"]], decls: 70, vars: 39, consts: [[1, "container"], [1, "container-fluid"], ["novalidate", "", 3, "ngSubmit"], ["register", "ngForm"], [1, "form-group"], ["for", "uname_id"], ["type", "text", "id", "uname_id", "name", "username", "required", "", "pattern", "\\S{3,30}", "minlength", "3", "maxlength", "30", 1, "form-control", 3, "ngModel", "ngModelChange"], ["uname", "ngModel"], [4, "ngIf"], ["for", "email_id"], ["type", "email", "name", "email", "required", "", "maxlength", "50", "pattern", "\\S{1,40}@gmail\\.com$", "id", "email_id", 1, "form-control", 3, "ngModel", "ngModelChange"], ["email", "ngModel"], ["for", "pass_id"], ["type", "password", "name", "password", "pattern", "\\S{8,30}", "required", "", "minlength", "8", "maxlength", "30", "id", "pass_id", 1, "form-control", 3, "ngModel", "ngModelChange"], ["pass", "ngModel"], ["for", "conf_pass_id"], ["type", "password", "name", "conf_pass", "id", "conf_pass_id", "required", "", 1, "form-control", 3, "ngModel", "ngModelChange"], ["conf_pass", "ngModel"], ["for", "fname_id"], ["type", "text", "name", "first_name", "minlength", "3", "maxlength", "30", "pattern", "\\S{3,30}", "required", "", "id", "fname_id", 1, "form-control", 3, "ngModel", "ngModelChange"], ["fname", "ngModel"], ["for", "lname_id"], ["type", "text", "name", "last_name", "required", "", "minlength", "3", "maxlength", "30", "pattern", "\\S{3,30}", "id", "lname_id", 1, "form-control", 3, "ngModel", "ngModelChange"], ["lname", "ngModel"], ["ngModelGroup", "profile"], ["for", "addr_id"], ["type", "text", "id", "addr_id", "name", "address", "required", "", "minlength", "10", "maxlength", "100", 1, "form-control", 3, "ngModel", "ngModelChange"], ["addr", "ngModel"], ["for", "pin_id"], ["type", "text", "id", "pin_id", "pattern", "^[1-9][0-9]{5}$", "name", "pincode", "required", "", 1, "form-control", 3, "ngModel", "ngModelChange"], ["pin", "ngModel"], ["for", "contact_id"], ["type", "text", "id", "contact_id", "name", "contact_no", "required", "", "pattern", "^[1-9][0-9]{9}$", 1, "form-control", 3, "ngModel", "ngModelChange"], ["phone", "ngModel"], ["for", "bio_id"], ["type", "text", "id", "bio_id", "name", "bio", "maxlength", "100", 1, "form-control", 3, "ngModel", "ngModelChange"], ["bio", "ngModel"], ["type", "submit", 1, "btn", "btn-primary", 3, "disabled"], ["class", "text-danger", 4, "ngIf"], [1, "text-danger"]], template: function RegisterComponent_Template(rf, ctx) { if (rf & 1) {
    ...
    } }, directives: [_angular_forms__WEBPACK_IMPORTED_MODULE_6__["ɵangular_packages_forms_forms_y"], _angular_forms__WEBPACK_IMPORTED_MODULE_6__["NgControlStatusGroup"], _angular_forms__WEBPACK_IMPORTED_MODULE_6__["NgForm"], _angular_forms__WEBPACK_IMPORTED_MODULE_6__["DefaultValueAccessor"], _angular_forms__WEBPACK_IMPORTED_MODULE_6__["RequiredValidator"], _angular_forms__WEBPACK_IMPORTED_MODULE_6__["PatternValidator"], _angular_forms__WEBPACK_IMPORTED_MODULE_6__["MinLengthValidator"], _angular_forms__WEBPACK_IMPORTED_MODULE_6__["MaxLengthValidator"], _angular_forms__WEBPACK_IMPORTED_MODULE_6__["NgControlStatus"], _angular_forms__WEBPACK_IMPORTED_MODULE_6__["NgModel"], _angular_common__WEBPACK_IMPORTED_MODULE_7__["NgIf"], _angular_forms__WEBPACK_IMPORTED_MODULE_6__["NgModelGroup"]], styles: [""] });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](RegisterComponent, [{
    ...
    }], function () { return [{ type: _app_services_auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"] }, { type: _app_services_register_service__WEBPACK_IMPORTED_MODULE_4__["RegisterService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_5__["ActivatedRoute"] }]; }, null); })();
...
class BidEvent {
    constructor(product, id = null, date_added = null, start_date = null, deadline = null, base_price = null, current_date) {
...
class Product {
    constructor(name = null, category = null, description = null, image = null) {
...
class Profile {
    constructor(bio = null, contact_no = null, address = null, pincode = null, image = null, is_auctioneer = false, is_bidder = false) {
        this.bio = bio;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ShareEventNode", function() { return ShareEventNode; });
class ShareEventNode {
    constructor() {
        this.event_list = [];
    }
}
...
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/common.js");
/* harmony import */ var _app_dashboard_admin_user_update_by_admin_user_update_by_admin_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @app/dashboard/admin/user-update-by-admin/user-update-by-admin.component */ "./src/app/dashboard/admin/user-update-by-admin/user-update-by-admin.component.ts");
...
function AdminComponent_ng_container_18_ng_container_4_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpropertyInterpolate"]("src", ctx_r9.user.profile.image, _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsanitizeUrl"]);
} }
function AdminComponent_ng_container_18_ng_container_18_Template(rf, ctx) { if (rf & 1) {
    const _r12 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "button", 18);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AdminComponent_ng_container_18_ng_container_18_Template_button_click_1_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r12); const ctx_r11 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2); return ctx_r11.deleteUser(); });
...
function AdminComponent_ng_container_18_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](4, AdminComponent_ng_container_18_ng_container_4_Template, 2, 1, "ng-container", 13);
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AdminComponent_ng_container_18_Template_button_click_15_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r14); const ctx_r13 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r13.onClickUpdateUser(); });
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](24, "th", 20);
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](4);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngIf", ctx_r3.user.profile.image != null);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](3);
...
class AdminComponent {
    constructor(userService, shareUser) {
...
AdminComponent.ɵfac = function AdminComponent_Factory(t) { return new (t || AdminComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_app_services_user_service__WEBPACK_IMPORTED_MODULE_3__["UserService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_app_services_share_user_service__WEBPACK_IMPORTED_MODULE_4__["ShareUserService"])); };
AdminComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AdminComponent, selectors: [["app-admin"]], decls: 20, vars: 5, consts: [[1, "container"], [1, "container-fluid"], [1, "col", "mb-4"], [1, "card", "text-white", "bg-dark", "mb-3"], [1, "card-body"], [1, "card-title"], [1, "card-text"], [3, "ngSubmit"], ["searchUser", "ngForm"], [1, "form-group"], ["for", "username_id"], ["type", "text", "name", "user", "pattern", "^\\S{3,30}$", "required", "", "id", "username_id", 1, "form-control", 3, "ngModel", "ngModelChange"], ["uname", "ngModel"], [4, "ngIf"], ["type", "submit", 1, "btn", "btn-primary", 3, "disabled"], ["class", "text-danger", 4, "ngIf"], [1, "text-danger"], [1, "row", "row-cols-1", "row-cols-md-2"], [1, "btn", "btn-primary", 3, "click"], [1, "table", "table-hover", "table-dark"], ["scope", "col"], ["scope", "row"], ["alt", "My Profile", 1, "card-img-top", 3, "src"], [3, "updated_user"]], template: function AdminComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "div", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](2, "div", 2);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](3, "div", 3);
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AdminComponent, [{
  ...
  `]
    ...
    }], function () { return [{ type: _app_services_user_service__WEBPACK_IMPORTED_MODULE_3__["UserService"] }, { type: _app_services_share_user_service__WEBPACK_IMPORTED_MODULE_4__["ShareUserService"] }]; }, null); })();
...
UserUpdateByAdminComponent.ɵfac = function UserUpdateByAdminComponent_Factory(t) { return new (t || UserUpdateByAdminComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_app_services_user_service__WEBPACK_IMPORTED_MODULE_1__["UserService"])); };
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](UserUpdateByAdminComponent, [{
    ...
    }], function () { return [{ type: _app_services_user_service__WEBPACK_IMPORTED_MODULE_1__["UserService"] }]; }, { updated_user: [{
...
EventCreateComponent.ɵfac = function EventCreateComponent_Factory(t) { return new (t || EventCreateComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_app_services_event_service__WEBPACK_IMPORTED_MODULE_3__["EventService"])); };
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](EventCreateComponent, [{
    ...
    }], function () { return [{ type: _app_services_event_service__WEBPACK_IMPORTED_MODULE_3__["EventService"] }]; }, null); })();
...
/* harmony import */ var _app_services_share_event_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @app/services/share-event.service */ "./src/app/services/share-event.service.ts");
...
/* harmony import */ var _app_services_share_user_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @app/services/share-user.service */ "./src/app/services/share-user.service.ts");
/* harmony import */ var _app_services_bid_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @app/services/bid.service */ "./src/app/services/bid.service.ts");
/* harmony import */ var _app_services_event_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @app/services/event.service */ "./src/app/services/event.service.ts");
...
function EventDetailComponent_ng_container_51_ng_container_10_div_6_small_1_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "small");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, "Bid price is required");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
function EventDetailComponent_ng_container_51_ng_container_10_div_6_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
...
function EventDetailComponent_ng_container_51_ng_container_10_div_7_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
...
function EventDetailComponent_ng_container_51_ng_container_10_Template(rf, ctx) { if (rf & 1) {
    const _r10 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "form", 11, 12);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function EventDetailComponent_ng_container_51_ng_container_10_Template_form_ngSubmit_1_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r10); const ctx_r9 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2); return ctx_r9.validate_bid(); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](3, "div", 13);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](4, "input", 14, 15);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function EventDetailComponent_ng_container_51_ng_container_10_Template_input_ngModelChange_4_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r10); const ctx_r11 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2); return ctx_r11.user_bidprice = $event; });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
function EventDetailComponent_ng_container_51_ng_container_17_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerEnd"]();
} if (rf & 2) {
...
function EventDetailComponent_ng_container_51_Template(rf, ctx) { if (rf & 1) {
    const _r13 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EventDetailComponent_ng_container_51_Template_button_click_7_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r13); const ctx_r12 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r12.onClick(); });
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EventDetailComponent_ng_container_51_Template_button_click_12_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r13); const ctx_r14 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r14.getHighestBid(); });
...
function EventDetailComponent_ng_container_52_Template(rf, ctx) { if (rf & 1) {
    const _r16 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "button", 6);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EventDetailComponent_ng_container_52_Template_button_click_1_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r16); const ctx_r15 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r15.deleteEvent(); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](2, "Delete Event");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerEnd"]();
} }
class EventDetailComponent {
    constructor(router, route, shareEvent, authService, shareUser, bidService, eventService) {
        this.router = router;
        this.route = route;
        this.shareEvent = shareEvent;
        this.authService = authService;
    ...
    deleteEvent() {
        ...
        if (answer) {
            ...
            this.eventService.deleteEventByAdmin(this.event_id).subscribe(resp => alert("successfully deleted"), error => alert(error));
        }
    }
    onClick() {
        this.take_bid = true;
    ...
    validate_bid() {
        if (this.user_bidprice >= this.event.base_price && this.user_bidprice <= 100000000) {
            ...
            //send bid
            this.bidService.place_bid(bid, this.event.id).subscribe(resp => { alert("bid successfully placed"); }, error => { alert(error); });
            this.take_bid = false;
        }
        else
            this.is_error = true;
...
EventDetailComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: EventDetailComponent, selectors: [["app-event-detail"]], decls: 55, vars: 19, consts: [[1, "container"], [1, "container-fluid"], [1, "table", "table-hover", "table-dark"], ["scope", "col"], ["scope", "row"], [4, "ngIf"], [1, "btn", "btn-primary", 3, "click"], [1, "col", "mb-4"], [1, "card", "text-white", "bg-dark", "mb-3"], [1, "card-body"], [1, "card-text"], [3, "ngSubmit"], ["register_bid", "ngForm"], [1, "form-group"], ["type", "number", "name", "bidprice", "required", "", 1, "form-control", 3, "ngModel", "ngModelChange"], ["bidprice", "ngModel"], [1, "btn", "btn-primary", 3, "disabled"]], template: function EventDetailComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "div", 1);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EventDetailComponent_Template_button_click_53_listener() { return ctx.goBack(); });
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](EventDetailComponent, [{
    ...
    }], function () { return [{ type: _angular_router__WEBPACK_IMPORTED_MODULE_6__["Router"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_6__["ActivatedRoute"] }, { type: _app_services_share_event_service__WEBPACK_IMPORTED_MODULE_7__["ShareEventService"] }, { type: _app_services_auth_service__WEBPACK_IMPORTED_MODULE_8__["AuthService"] }, { type: _app_services_share_user_service__WEBPACK_IMPORTED_MODULE_9__["ShareUserService"] }, { type: _app_services_bid_service__WEBPACK_IMPORTED_MODULE_10__["BidService"] }, { type: _app_services_event_service__WEBPACK_IMPORTED_MODULE_11__["EventService"] }]; }, null); })();
...
function EventListComponent_ng_container_10_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](18, "small", 16);
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](5);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"]("Event Id\u00A0:\u00A0", event_r2.id, "");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpropertyInterpolate1"]("routerLink", "/events/", event_r2.id, "");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpropertyInterpolate"]("src", event_r2.product.image, _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsanitizeUrl"]);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpropertyInterpolate"]("alt", event_r2.product.category);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](3);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"](_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpipeBind1"](11, 8, event_r2.product.name));
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](3);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"]("Start Date\u00A0:\u00A0", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpipeBind2"](14, 10, event_r2.start_date, "medium"), "");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](3);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"]("Base Price\u00A0:\u00A0", event_r2.base_price, "");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](3);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"](_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpipeBind1"](20, 13, event_r2.product.description));
} }
class EventListComponent {
    ...
    ngOnInit() {
        ...
        this.shareEvent.getShareEventNode().subscribe(value => {
            this.eventListObject = value;
...
EventListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: EventListComponent, selectors: [["app-event-list"]], decls: 11, vars: 3, consts: [[1, "container"], [1, "container-fluid"], [1, "card", "text-white", "bg-dark", "mb-3"], [1, "card-body"], ["type", "datetime-local", "name", "inputdate", "placeholder", "filter events by date", "required", "", 3, "ngModel", "ngModelChange"], ["inputdate", "ngModel"], [1, "card-text"], [1, "btn", "btn-primary", 3, "disabled", "click"], [1, "row", "row-cols-1", "row-cols-md-3"], [4, "ngFor", "ngForOf"], [1, "col", "mb-4"], [1, "card-header"], [3, "routerLink"], [1, "card-img-top", 3, "src", "alt"], [1, "card-title"], [1, "card-footer"], [1, "text-muted"]], template: function EventListComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EventListComponent_Template_button_click_7_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r3); const _r0 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](5); return ctx.filtering(_r0.value); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](10, EventListComponent_ng_container_10_Template, 21, 15, "ng-container", 9);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    } if (rf & 2) {
...
function ProfileImageComponent_ng_container_3_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
    ...
    const ctx_r0 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpropertyInterpolate"]("src", ctx_r0.image_url, _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsanitizeUrl"]);
} }
...
function ProfileImageComponent_div_8_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function ProfileImageComponent_div_8_Template_form_ngSubmit_1_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r4); const ctx_r3 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r3.onSubmit(); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](2, "div", 10);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](3, "input", 11);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function ProfileImageComponent_div_8_Template_input_change_3_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r4); const ctx_r5 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r5.onFileSelect($event); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](4, ProfileImageComponent_div_8_div_4_Template, 2, 0, "div", 3);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    ...
    const ctx_r1 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](4);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngIf", ctx_r1.is_error);
} }
class ProfileImageComponent {
    constructor(shareUser, userService) {
        this.shareUser = shareUser;
        this.userService = userService;
        this.image_url = null;
        this.is_error = false;
    ...
    onSubmit() {
        if (!this.is_error && this.imagefile != null) {
            ...
            this.userService.updateProfileImage(formData, filename).subscribe(resp => alert("profile image successfully updated...refresh profile"), error => {
                alert(error);
            });
        }
        this.want_to_update = false;
...
ProfileImageComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ProfileImageComponent, selectors: [["app-profile-image"]], decls: 9, vars: 2, consts: [[1, "row", "row-cols-1", "row-cols-md-2"], [1, "col", "mb-4"], [1, "card", "text-white", "bg-dark", "mb-3"], [4, "ngIf"], [1, "card-body"], [1, "card-text"], [1, "btn", "btn-primary", 3, "click"], ["class", "card-text", 4, "ngIf"], ["alt", "My Profile", 1, "card-img-top", 3, "src"], [1, "form-group", 3, "ngSubmit"], [1, "custom-file"], ["type", "file", "name", "image", "accept", ".jpg,.jpeg", "required", "", 3, "change"], ["type", "submit", 1, "btn", "btn-primary"]], template: function ProfileImageComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "div", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](2, "div", 2);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](3, ProfileImageComponent_ng_container_3_Template, 2, 1, "ng-container", 3);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](4, "div", 4);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](3);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngIf", ctx.image_url != null);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](5);
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ProfileImageComponent, [{
    ...
    }], function () { return [{ type: _app_services_share_user_service__WEBPACK_IMPORTED_MODULE_1__["ShareUserService"] }, { type: _app_services_user_service__WEBPACK_IMPORTED_MODULE_2__["UserService"] }]; }, null); })();
...
class ProfileUpdateComponent {
    ...
    profileUpdate() {
        this.userService.updateProfileByUser(this.updated_user).subscribe(resp => alert("profile updated successfully"), error => alert(error));
    }
}
ProfileUpdateComponent.ɵfac = function ProfileUpdateComponent_Factory(t) { return new (t || ProfileUpdateComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_app_services_user_service__WEBPACK_IMPORTED_MODULE_1__["UserService"])); };
...
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/common.js");
/* harmony import */ var _app_dashboard_profile_profile_update_profile_update_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @app/dashboard/profile/profile-update/profile-update.component */ "./src/app/dashboard/profile/profile-update/profile-update.component.ts");
...
function ProfileComponent_ng_container_6_Template(rf, ctx) { if (rf & 1) {
    ...
    const ctx_r0 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpropertyInterpolate"]("src", ctx_r0.user.profile.image, _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsanitizeUrl"]);
} }
function ProfileComponent_ng_container_64_Template(rf, ctx) { if (rf & 1) {
    const _r5 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "button", 10);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ProfileComponent_ng_container_64_Template_button_click_1_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r5); const ctx_r4 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r4.user_request(ctx_r4.user.first_name, "bid"); });
...
ProfileComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ProfileComponent, selectors: [["app-profile"]], decls: 67, vars: 17, consts: [[1, "container"], [1, "container-fluid"], [1, "row", "row-cols-1", "row-cols-md-2"], [1, "col", "mb-4"], [1, "card", "text-white", "bg-dark", "mb-3"], ["routerLink", "/profile/image"], [4, "ngIf"], [1, "card-body"], [1, "card-title"], [1, "card-text"], [1, "btn", "btn-primary", 3, "click"], [1, "table", "table-hover", "table-dark"], ["scope", "col"], ["scope", "row"], ["alt", "My Profile", 1, "card-img-top", 3, "src"], [3, "user"]], template: function ProfileComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "div", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](2, "div", 2);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](3, "div", 3);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](6, ProfileComponent_ng_container_6_Template, 2, 1, "ng-container", 6);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](64, ProfileComponent_ng_container_64_Template, 3, 0, "ng-container", 6);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](65, ProfileComponent_ng_container_65_Template, 3, 0, "ng-container", 6);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](66, ProfileComponent_ng_container_66_Template, 2, 1, "ng-container", 6);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    } if (rf & 2) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](6);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngIf", ctx.user.profile.image != null);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](3);
    ...
    } }, directives: [_angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterLinkWithHref"], _angular_common__WEBPACK_IMPORTED_MODULE_4__["NgIf"], _app_dashboard_profile_profile_update_profile_update_component__WEBPACK_IMPORTED_MODULE_5__["ProfileUpdateComponent"]], pipes: [_angular_common__WEBPACK_IMPORTED_MODULE_4__["TitleCasePipe"]], styles: [""] });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ProfileComponent, [{
  ...
  `]
    ...
    }], function () { return [{ type: _app_services_auth_service__WEBPACK_IMPORTED_MODULE_1__["AuthService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] }, { type: _app_services_share_user_service__WEBPACK_IMPORTED_MODULE_3__["ShareUserService"] }]; }, null); })();
...
AuthTokenInterceptor.ɵfac = function AuthTokenInterceptor_Factory(t) { return new (t || AuthTokenInterceptor)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_app_services_auth_service__WEBPACK_IMPORTED_MODULE_1__["AuthService"])); };
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AuthTokenInterceptor, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"]
    }], function () { return [{ type: _app_services_auth_service__WEBPACK_IMPORTED_MODULE_1__["AuthService"] }]; }, null); })();
...
class AuthService {
    ...
    handleError(error) {
        ...
        if (error.error instanceof ErrorEvent) {
            ...
            if (error.status == 400)
                return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["throwError"])("invalid crediantails....try again!!!");
            if (error.status == 0)
            ...
            if (error.status == 404)
                return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["throwError"])("detail not found");
        }
    }
    ;
    login(LoginUser) {
    ...
    handleError(error) {
        if (error.error instanceof ErrorEvent) {
            ...
            if (error.status == 400)
                ...
                Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["throwError"])("server error....contact admin!!!");
        }
    }
    ;
    registerUser(user) {
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _app_classes_share_event_node__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @app/classes/share-event-node */ "./src/app/classes/share-event-node.ts");
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/_esm2015/index.js");
...
class ShareEventService {
    ...
    setShareEventNode(shareEventNode) {
